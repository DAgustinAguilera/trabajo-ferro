...
`,
    ...
    var ret_mit_mark = L.marker([380, 465], { icon: myIcon2 })
      ...
      .addTo(map)
      .bindPopup(
        '<b class="sansserif d-flex justify-content-center">Maipú - Delta</b><br><b class="sansserif">Velocidad máxima: 70km/h.<br/>Motivo: Infraestructura de via instalada en 1994<br/>Precauciones: entre 8 y 40km/h en algunos sectores debido a los ingresos a terminal, radios de curva y falta de mantenimiento de vía.</b>'
      );
